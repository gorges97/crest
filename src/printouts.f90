...
subroutine confscript_head
      ...
      write(*,'(7x,''=============================================='')')
      write(*,'(7x,''modified msreact Version '',a,'', '',a)')trim(version),trim(date)
...
!      write(*,'(5x,''-fixens            : fix the solute during the ensemble generation'')')
  ...
  write(*,*)
      ...
      write(*,'(1x,''Specific options for msreact mode:'')')
      write(*,'(5x,''-msreact             : generate fragments and isomers of input structure'')')
      write(*,'(5x,''-msiso               : print only non-dissociated structures (isomers)'')')
      write(*,'(5x,''-msnoiso             : print only dissociated structures'')')
      write(*,'(5x,''-msnshifts [int]      : shift atoms ntimes before optimization (default 50) '')')
       write(*,'(5x,''-msnshifts2 [int]    : shift atoms ntimes before applying repulsive potential (default 0) '')')
      write(*,'(5x ''-msnbonds [int]      : maximum number of bonds between atoms pairs for applying repulsive potential (default 3)'')')
      write(*,'(5x ''-msnfrag [int]       : number of fragments that are printed by msreact'')')
      write(*,'(5x,''-msmolbar            : sort out duplicates by molbar (requires  sourced "molbar")'')')
      write(*,'(5x,''-msinchi             : sort out duplicates by inchi (requires  sourced "obabel")'')')
      write(*,'(5x,''-mstopo              : sort out duplicates by topology'')')
      write(*,'(5x,''-msstopo              : sort out duplicates by simple topology'')')
       write(*,'(5x,''-msattrh             : add atrractive potential between hydrogen and LMO centers'')')
       write(*,'(5x,''-mslargeprint       : do not remove temporary files and MSDIR'')')
