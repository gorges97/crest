...
!      write(*,'(5x,''-fixens            : fix the solute during the ensemble generation'')')
  ...
  write(*,*)
      ...
      write(*,'(5x,''-msshifts [int]      : shift atoms ntimes before optimization (default 50) '')')
       write(*,'(5x,''-msshifts2 [int]    : shift atoms ntimes before applying repulsive potential (default 0) '')')
